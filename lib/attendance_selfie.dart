                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: const Color(0xFFBEBEC7), width: 1)),
                        padding: const EdgeInsets.all(15),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            const Text("Attendance Selfie",
                                style: TextStyle(
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: (firebaseUser == null || _isLoading)
                                    ? null
                                    : _captureAndSubmitAttendance,
                                icon: _isLoading
                                    ? const SizedBox(
                                ...
                                label: Text(
                                    _isLoading ? 'Processing...' : 'Submit Attendance'),
                            ...
                            if (firebaseUser != null)
                              Center(
                                  child: Text(
                                      'Signed in as: ${firebaseUser.email ?? widget.userEmail}',
                                      style: const TextStyle(
                                          color: Colors.black54))),
                            if (firebaseUser == null)
                              Center(
                                  child: Text(
                                      'Not signed in. Using: ${widget.userEmail}',
                                      style: const TextStyle(
                                ...
                                children: const [
                                  Row(children: [
                                    Icon(Icons.tips_and_updates_rounded,
                                        color: Color(0xFF288AD6), size: 18),
                                    SizedBox(width: 6),
                                  ...
                                  Text("• Face the camera directly",
                                      style: TextStyle(fontSize: 13.1)),
                                  Text("• Remove sunglasses or masks if possible",
                                      style: TextStyle(fontSize: 13.1)),
                                  Text("• Location will be automatically captured",
                                      style: TextStyle(fontSize: 13.1)),
                                ],
                              ),
                            )
